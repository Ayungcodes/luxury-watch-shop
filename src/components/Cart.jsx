...
const total = subtotal + shipping;
  ...
  return (
    <>
        <div className="fixed inset-0 z-60 rounded-3xl mx-auto my-auto h-[74vh] md:h-[70vh] w-[87vw] md:w-[70vw] lg:h-[77vh] lg:w-[45vw] bg-gray-300 transition-transform ease-linear duration-300">
